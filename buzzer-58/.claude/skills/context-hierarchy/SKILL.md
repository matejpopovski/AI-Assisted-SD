...
This project's instructions (T3) call the underlying technique "the README trick" and accept
plain `README.md` files too — this skill is one implementation of that same idea, not a
different requirement. Pick whichever you'd rather maintain; both are graded the same way.

## Scope

Covers the source tree, not the repo root's own README/setup docs. See this project's root
`CLAUDE.md` for which directories T3 asks you to cover.
...
does this automatically as you work.
